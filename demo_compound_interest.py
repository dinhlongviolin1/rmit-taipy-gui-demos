...
data = pd.DataFrame(columns=["Year", "Contribution", "Interest", "Total"])
...
def calculate(state):
    ...
    state.data = pd.DataFrame(calculate_data, columns=["Year", "Contribution", "Interest", "Total"])
...
<|{data}|chart|type=bar|x=Year|y[1]=Interest|y[2]=Contribution|y[3]=Total|height=600px|>
"""
